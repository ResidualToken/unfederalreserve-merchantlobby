...
contract('UnFederalReserveMaker', ([alice, bar, minter]) => {
    beforeEach(async () => {
        ...
        this.maker = await UnFederalReserveMaker.new(this.factory.address, bar, this.sushi.address, this.weth.address);
